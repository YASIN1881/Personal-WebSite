const navIconOpen = document.querySelector('.nav__toggle-icon')
...
if(window.localStorage.getItem('theme')=== "dark-theme"){
    ...
    changeThemeBtn.innerHTML = darkTheme
}
...
navigationTabsInit(portfolioListItems,'portfolio-list__item--active','portfolio__content--show')
